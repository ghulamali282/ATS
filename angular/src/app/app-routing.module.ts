...
const routes: Routes = [
  ...
  },
  {
    path: 'amm',
    loadChildren: () =>
      import('Amm/projects/amm').then(m => m.AmmModule.forLazy()),
  },
  {
    path: 'crm',
    loadChildren: () =>
      import('Crm/projects/crm').then(m => m.CrmModule.forLazy()),
  },
  {
    path: 'ccm',
    loadChildren: () =>
      import('Ccm/projects/ccm').then(m => m.CcmModule.forLazy()),
  },
];
