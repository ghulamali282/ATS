...
namespace ATS.Web.Public.Menus
{
    public class ATSPublicMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public ATSPublicMenuContributor(IConfiguration configuration)
        {
        ...
        {
            var l = context.GetLocalizer<ATSResource>();

            //Home
            context.Menu.AddItem(
                new ApplicationMenuItem(
                    ATSPublicMenus.HomePage,
                    l["Menu:Home"],
                    "~/",
                    icon: "fa fa-home",
                    order: 1
