...
namespace ATS
{
    ...
    [DependsOn(typeof(AmmDomainModule))]
    [DependsOn(typeof(CcmDomainModule))]
            ...
            Configure<NewsletterOptions>(options =>
            {
                options.AddPreference(
                    ...
                    new NewsletterPreferenceDefinition(
                        LocalizableString.Create<ATSResource>("NewsletterPreference_Default"),
                        privacyPolicyConfirmation: LocalizableString.Create<ATSResource>("NewsletterPrivacyAcceptMessage")
                    )
                );
            });
